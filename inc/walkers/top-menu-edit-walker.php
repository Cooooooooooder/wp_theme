			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<div class="description-group">
					...
					<p class="field-icon description description-thin">
						<label for="edit-menu-item-icon-<?php echo $item_id; ?>">
							<?php _e('Icon'); ?><br />
							<input type="text" id="edit-menu-item-icon-<?php echo $item_id; ?>" class="widefat code edit-menu-item-icon" name="menu-item-icon[<?php echo $item_id; ?>]" value="<?php echo htmlspecialchars($menu_item->icon, ENT_QUOTES); ?>" />
						</label>
					</p>
				</div>
				<p class="field-description description description-wide">
					<label for="edit-menu-item-description-<?php echo $item_id; ?>">
						...
						<textarea id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo $item_id; ?>]"><?php echo esc_textarea($menu_item->description); // textarea_escaped 
																																																				?></textarea>
...
add_action('wp_update_nav_menu_item', function ($menu_id, $menu_item_db_id, $menu_item_args) {
	if (is_array($_POST['menu-item-icon'])) {
		update_post_meta(
			$menu_item_db_id,
			'_menu_item_icon',
			sanitize_html_class($_POST['menu-item-icon'][$menu_item_db_id])
		);
	}
}, 10, 3);
