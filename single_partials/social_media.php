  ...
  <div class="post-sharing">
      <ul class="list-inline">
          ...
          <li><a target="_blank" href="https://twitter.com/intent/tweet?url=<?php echo $args['post_link']; ?>" class="tw-button btn btn-primary"><i class="fa fa-twitter"></i> <span class="down-mobile">Tweet on Twitter</span></a></li>
      </ul>
